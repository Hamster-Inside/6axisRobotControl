...
if (step1 == axis1_00 && step2 == axis2_00 && step3 == axis3_00 && step4 == axis4_00 && step5 == axis5_00 && step6 == axis6_00){
  sitting_on_0 = true;
}
else{
  sitting_on_0 = false;
}
// JEŻELI ROBOT JEST ZBAZOWANY POPRAWNIE i siedzi na "0" - PROGRAM DO FULL AUTO
if (digitalRead(startprog) == HIGH && sitting_on_0 == true && end_of_program1 == true){
  end_of_program1 = false;
  base_position = 0;
  done_running = true;
  you_can_move_auto = true;
  go_round_program1 = true;
  counter_stage = 0;
}

if (digitalRead(stopprog) == HIGH) {
  go_round_program1 = false;
  
}
if (digitalRead(EMRstop) == HIGH){
  you_can_move_auto = false;
}
if (you_can_move_auto == true){
Program_1_ON = true;
}
else {
Program_1_ON = false;
}
if (Program_1_ON == true){
  program_counter();
}
